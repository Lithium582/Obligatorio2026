...
La primera grilla mostr? una mejora clara al aumentar la profundidad de 3 a 5
y la segunda confirm? una nueva mejora con profundidad 7. La mayor media de CV
fue 0,938565 con \texttt{min\_child\_weight=5}. Sin embargo, se seleccion? el
valor 15 porque redujo el gap train--validaci?n de 0,014283 a 0,013085 a cambio
de s?lo 0,000288 de ROC AUC.

\begin{table}[htbp]
    \centering
    \caption{Comparaci?n t?cnica de los modelos finales sobre 2017.}
    ...
    \begin{tabular}{lrrrrrr}
        ...
        \midrule
        LR mejorada & 0,908557 & 0,855017 & 0,739032 & 0,620290 & 0,839568 & 0,713461 \\
        ?rbol podado & 0,927092 & 0,838694 & 0,765822 & 0,723456 & 0,639187 & 0,678716 \\
        Random Forest & 0,941260 & 0,842641 & 0,769312 & 0,748885 & 0,607621 & 0,670898 \\
...
0,070986, menor que los observados en el ?rbol y Random Forest. Con threshold
0,5 present? un compromiso m?s equilibrado entre Precision y Recall que los
otros modelos basados en ?rboles. Logistic Regression mantuvo el mejor Recall
y un F1 ligeramente superior, por lo que la decisi?n operativa final deber?
comparar sus probabilidades bajo una pol?tica de threshold y costos com?n.

\subsection{KNN}

La b?squeda de KNN se realiz? sobre una muestra agrupada de 27.137 reservas de
desarrollo para limitar el costo del c?lculo de distancias. Se compararon 25 y
75 vecinos con ponderaci?n uniforme o por distancia, utilizando tres folds. La
configuraci?n seleccionada emple? 75 vecinos ponderados y obtuvo ROC AUC medio
0,876338, con desviaci?n 0,008868. Esta estimaci?n sobre una muestra no es
directamente comparable con las validaciones completas de los dem?s modelos.

El ROC AUC de entrenamiento cercano a uno de las configuraciones ponderadas no
se tom? como evidencia convencional de sobreajuste: al predecir el propio
entrenamiento, cada observaci?n es su vecina a distancia cero. La comparaci?n
se bas? en los folds no observados y la evaluaci?n temporal posterior.
...
KNN present? el menor ROC AUC temporal de los modelos entrenados. Aunque su
Precision fue alta, omiti? m?s de cuatro de cada diez cancelaciones. La p?rdida
de capacidad de ordenamiento es coherente con la dificultad de definir
cercan?a en el espacio de alta dimensi?n producido por One-Hot Encoding. Por
este motivo no se ampli? la grilla y el modelo se conserva como comparaci?n de
